...
_SYNTHESIZEREQUEST_PCM = _descriptor.EnumDescriptor(
  name='Pcm',
  full_name='ondewo.t2s.SynthesizeRequest.Pcm',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_SYNTHESIZEREQUEST_PCM)
...
_SYNTHESIZEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='t2s_pipeline_id', full_name='ondewo.t2s.SynthesizeRequest.t2s_pipeline_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='text', full_name='ondewo.t2s.SynthesizeRequest.text', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='length_scale', full_name='ondewo.t2s.SynthesizeRequest.length_scale', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='noise_scale', full_name='ondewo.t2s.SynthesizeRequest.noise_scale', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sample_rate', full_name='ondewo.t2s.SynthesizeRequest.sample_rate', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pcm', full_name='ondewo.t2s.SynthesizeRequest.pcm', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='audio_format', full_name='ondewo.t2s.SynthesizeRequest.audio_format', index=6,
...
_SYNTHESIZERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='audio', full_name='ondewo.t2s.SynthesizeResponse.audio', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='generation_time', full_name='ondewo.t2s.SynthesizeResponse.generation_time', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='audio_length', full_name='ondewo.t2s.SynthesizeResponse.audio_length', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='t2s_pipeline_id', full_name='ondewo.t2s.SynthesizeResponse.t2s_pipeline_id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='audio_format', full_name='ondewo.t2s.SynthesizeResponse.audio_format', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='text', full_name='ondewo.t2s.SynthesizeResponse.text', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sample_rate', full_name='ondewo.t2s.SynthesizeResponse.sample_rate', index=6,
...
_SYNTHESIZEREQUEST.fields_by_name['pcm'].enum_type = _SYNTHESIZEREQUEST_PCM
_SYNTHESIZEREQUEST.fields_by_name['audio_format'].enum_type = _AUDIOFORMAT
_SYNTHESIZEREQUEST_PCM.containing_type = _SYNTHESIZEREQUEST
_SYNTHESIZERESPONSE.fields_by_name['audio_format'].enum_type = _AUDIOFORMAT
