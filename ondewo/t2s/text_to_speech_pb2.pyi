...
class RequestConfig(google.protobuf.message.Message):
    ...
    CHAR_MAPPING_FIELD_NUMBER: builtins.int
    ...
    @property
    def char_mapping(self) -> google.protobuf.struct_pb2.Struct:
