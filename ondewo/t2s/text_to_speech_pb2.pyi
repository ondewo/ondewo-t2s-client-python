...
class RequestConfig(google.protobuf.message.Message):
    ...
    PHONEME_CORRECTION_FIELD_NUMBER: builtins.int
    ...
    @property
    def phoneme_correction(self) -> google.protobuf.struct_pb2.Struct:
